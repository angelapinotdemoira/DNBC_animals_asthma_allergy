...
log using "D:\Data\workdata\707796\Results\Collated results\Rabbits rodents\AR_13years\FINAL\AR_log_ije.smcl"
...
strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) ///
...
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
 agebirth_m_y i.copenhagen if miss==0,  ///
 strata(allergy_f allergy_inh_m preg_smk sex children_cat) ///
 nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
est store adj_`var'
stphtest, log detail
drop sch* sca*
...
i.livestock_int1  ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, strata(sex children_cat preg_smk) ///
nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
...
xi: stcox i.cat i.dog i.rabbit i.rodent i.exotic  i.bird ///
 i.asthma_bf i.asthma_m i.allergy_inh_m  ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat   ///
 agebirth_m_y  copenhagen if miss2==0, strata(allergy_f  preg_smk sex children_cat) ///
 nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
...
xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.mat_ed_3cat  i.crowding_cat  ///
agebirth_m_y   i.children_cat preg_smk rhinitis_m_reg  if miss==0 & sex==1, ///
strata(i.hhincome_cat i.copenhagen rhinitis_p_reg) ///
 nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
...
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen i.children_cat preg_smk rhinitis_m_reg rhinitis_p_reg if ///
miss==0 & sex==2, nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
est store adj_`var'_`n'
stphtest, log detail
drop sch* sca*
}
...
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
agebirth_m_y   i.rhinitis_m_reg if miss==0, ///
strata(children_cat preg_smk  rhinitis_p_reg i.copenhagen ) ///
nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
stphtest, log detail
drop sch* sca*
} 
...
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
agebirth_m_y rhinitis_m_reg   if miss==0, ///
strata(children_cat preg_smk  rhinitis_p_reg i.copenhagen ) ///
nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
stphtest, log detail
drop sch* sca*
...
char crowding_cat[omit] 2
xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1*i.sex i.asthma_p_reg i.asthma_m_reg ///
i.mat_ed_3cat i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.rhinitis_m_reg    if miss==0, ///
strata(children_cat i.preg_smk rhinitis_p_reg i.copenhagen ) ///
nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
stphtest, log detail
drop sch* sca*
}
...
xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0 & mat_ed_3cat==`n', strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) nolog noshow schoenfeld(sch*) scaledsch(sca*) vce(cluster mcpr)
...
char mat_ed_3cat[omit] 2
char crowding_cat[omit] 2
quietly xi: stcox i.cat_int1 i.mat_ed_3cat i.dog_int1 i.rabbit_int1 i.rodent_int1 ///
...
char mat_ed_3cat[omit] 2
char crowding_cat[omit] 2
quietly xi: stcox i.cat_int1 i.dog_int1 i.mat_ed_3cat i.rabbit_int1 ///
i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, ///
strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) 
...
char mat_ed_3cat[omit] 2
char crowding_cat[omit] 2
quietly xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 i.mat_ed_3cat ///
i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, ///
...
char mat_ed_3cat[omit] 2
char crowding_cat[omit] 2
quietly xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 ///
i.rodent_int1 i.mat_ed_3cat i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, ///
strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) 
...
char crowding_cat[omit] 2
quietly xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 ///
i.rodent_int1 i.exotic_int1 i.bird_int1 i.mat_ed_3cat ///
i.livestock_int1 i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, ///
strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) 
...
quietly xi: stcox i.cat_int1 i.dog_int1 i.rabbit_int1 ///
i.rodent_int1 i.exotic_int1 i.bird_int1 ///
i.livestock_int1 i.mat_ed_3cat i.asthma_p_reg i.asthma_m_reg ///
i.hhincome_cat i.crowding_cat  ///
agebirth_m_y  i.copenhagen  if miss==0, ///
strata(sex children_cat preg_smk rhinitis_m_reg rhinitis_p_reg) 
est store a
...
rhinitis6_cox using table_rhinitis_0722.txt if miss==0, replace /// 
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & family_allergy_asthma==0, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & family_allergy_asthma==1, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & sex==1, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & sex==2, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & mat_ed_3cat==1, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & mat_ed_3cat==2, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat_int1 dog_int1 rabbit_int1 rodent_int1 exotic_int1 bird_int1 livestock_int1 ///
rhinitis6_cox using table_rhinitis_0722.txt if miss==0 & mat_ed_3cat==3, append ///
c(freq col) f(0c 1) clab(N %) 

tabout cat dog rabbit rodent exotic bird ///
rhinitis6_cox using table_rhinitis_timing_0722.txt if miss2==0, replace ///
c(freq col) f(0c 1) clab(N %) 
